...
for i in aaabasicfs glibc tzdata \
	...
	procps-ng grep readline bash \
	libtool gdbm inetutils perl \
	bzip2 file gawk findutils flex gettext \
	groff gzip iproute2 kbd less libpipeline make\
	man-db kmod patch psmisc shadow sysvinit systemd \
	tar texinfo vim pkgutils prt-get attr dbus \
	wget xz libarchive openssl pkg-config ports \
	rsync pkg-get cpio grub
